  ...
  return (
    <>
      <style>{`
        ...
        .cv-page.dark .edit-btn, .cv-page.dark .add-btn, .cv-page.dark .return-btn {
          background: #1abc9c;
        }
        .edit-btn:hover, .add-btn:hover, .return-btn:hover {
          background: #503a28;
          transform: translateY(-2px);
        }
        .cv-page.dark .edit-btn:hover, .cv-page.dark .add-btn:hover, .cv-page.dark .return-btn:hover {
          background: #16a085;
        }
        .return-btn {
          background: #7f8c8d;
        }
        .cv-page.dark .return-btn {
          background: #bdc3c7;
        }
        .return-btn:hover {
          background: #6c757d;
        }
        .cv-page.dark .return-btn:hover {
          background: #a1a9ac;
        }
        .notification {
          font-family: "Roboto", sans-serif;
